...
```kt
dependencies {
    implementation("io.fluidsonic.react:fluid-react-dom:0.9.5")        // basis module
    implementation("io.fluidsonic.react:fluid-react-router-dom:0.9.5") // if you want routing
    implementation("io.fluidsonic.react:fluid-react-coroutines:0.9.5") // if you want coroutine support
}
```
